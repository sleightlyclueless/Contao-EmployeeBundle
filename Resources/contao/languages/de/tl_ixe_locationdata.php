...
$GLOBALS['TL_LANG'][$strName]['new'] = ['Neuen Standort anlegen', 'Hier können Sie einen neuen Standort anlegen'];
$GLOBALS['TL_LANG'][$strName]['edit'] = ['Standort bearbeiten', 'Diesen Standort (ID %s) bearbeiten'];
$GLOBALS['TL_LANG'][$strName]['copy'] = ['Standort kopieren', 'Diesen Standort (ID %s) kopieren'];
$GLOBALS['TL_LANG'][$strName]['delete'] = ['Standort löschen', 'Diesen Standort (ID %s) löschen'];
$GLOBALS['TL_LANG'][$strName]['toggle'] = ['Standort ein-/ausblenden', 'Diesen Standort (ID %s) ein-/ausblenden'];
$GLOBALS['TL_LANG'][$strName]['show'] = ['Informationen zum Standort anzeigen', 'Informationen zum Mitarbeiter (ID %s) anzeigen'];
$GLOBALS['TL_LANG'][$strName]['main_legend'] = 'Standort Name und Typ';
...
$GLOBALS['TL_LANG'][$strName]['streetAdditional'] = ['Zusätzliche Straßenkennung', 'Sollten Sie noch zusätzlich etwas nach der Straße eintragen wollen, können Sie dies hier tun'];
$GLOBALS['TL_LANG'][$strName]['postalCode'] = ['Postleitzahl', 'Hier können Sie die PLZ zum Sitz des Standortes eingeben'];
$GLOBALS['TL_LANG'][$strName]['addressLocality'] = ['Stadt', 'Hier können Sie die Stadt zum Sitz des Standortes eingeben'];
...
$GLOBALS['TL_LANG'][$strName]['telephoneLinktext'] = ['Telefon Linktext', 'Hier können Sie optional einen darzustellenden Text für den Telefon - Link eingeben z.B. Jetzt anrufen'];
$GLOBALS['TL_LANG'][$strName]['faxNumberCteText'] = ['Fax CTE-Text', 'In dieses Textfeld können Sie einen CTE Text den Kontaktnummern voranstellen'];
...
$GLOBALS['TL_LANG'][$strName]['additionalProperty'] = ['Weitere Angaben', 'Hier können Sie weitere Angaben zum Standort tätigen'];
$GLOBALS['TL_LANG'][$strName]['addLink'] = ['Link hinzufügen', 'Aktivieren Sie diese Checkbox, um für den Standort einen Link hinzuzufügen'];
$GLOBALS['TL_LANG'][$strName]['linkTitle'] = ['Link-Text', 'Der Link-Text wird anstelle der Link-Adresse angezeigt.'];
$GLOBALS['TL_LANG'][$strName]['embed'] = ['Den Link einbetten', 'Verwenden Sie den Platzhalter "%s", um den Link in einen Text einzubetten (z.B. Für mehr Informationen besuchen Sie %s).'];
$GLOBALS['TL_LANG'][$strName]['titleText'] = ['Link-Titel', 'Der Link-Titel wird als title-Attribut im HTML-Markup eingefügt.'];
$GLOBALS['TL_LANG'][$strName]['rel'] = ['Lightbox', 'Hier können Sie ein data-lightbox-Attribut eingeben, um die Lightbox anzusteuern.'];
$GLOBALS['TL_LANG'][$strName]['published'] = ['Standort Veröffentlichen', 'Hier können Sie den Standort un-/veröffentlichen'];
