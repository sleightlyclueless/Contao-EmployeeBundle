...
$GLOBALS['TL_LANG'][$strName]['salutation_legend'] = 'Anrede & Titel';
$GLOBALS['TL_LANG'][$strName]['name_legend'] = 'Name & Nachname';
...
$GLOBALS['TL_LANG'][$strName]['salutation'] = ['Anrede Einstellungen', 'Hier können Sie die gewünschte Anrede zu der Kontaktperson eingeben (z.B. Herr, Frau, Divers auf deutsch). Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['title'] = ['Titel Einstellungen', 'Hier können Sie einen oder mehrere Titel der Kontaktperson eingeben (z.B. Dipl. Ing.). Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['jobtitle'] = ['Berufsbezeichnung Einstellungen', 'Hier können Sie die Berufsbezeichnung / den Berufsnamen des Mitarbeiters eingeben. Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['addLocation'] = ['Standort hinzufügen', 'Hier können Sie einstellen, ob ein Standort zu dem Mitarbeiter hinzugefügt werden soll'];
$GLOBALS['TL_LANG'][$strName]['locationCheckList'] = ['Standort', 'Hier können Sie Standorte auswählen, zu denen der Mitarbeiter hinzugehört. Diese Standorte können separat unter X-Theme -> Standorteverwaltung angelegt und verwaltet werden'];
...
$GLOBALS['TL_LANG'][$strName]['phone'] = ['Telefon Einstellungen', 'Hier können Sie eine Telefonnummer des Mitarbeiters hinterlegen. Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['fax'] = ['Fax Einstellungen', 'Hier können Sie eine Faxnummer des Mitarbeiters hinterlegen. Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['mobile'] = ['Mobil Einstellungen', 'Hier können Sie eine Mobilnummer des Mitarbeiters hinterlegen. Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['email'] = ['E-Mail Einstellungen', 'Hier können Sie eine Mailadresse des Mitarbeiters hinterlegen. Es ist nur eine Eingabe pro Sprache möglich! Wenn das Feld für eine gewisse Sprache leer sein aber angezeigt werden soll fügen Sie die Sprache dennoch hinzu und befüllen Sie das Feld mit einem non break space ([nbsp])'];
...
$GLOBALS['TL_LANG'][$strName]['published'] = ['Mitarbeiter veröffentlichen', 'Hier können Sie den Mitarbeiter un-/veröffentlichen'];
