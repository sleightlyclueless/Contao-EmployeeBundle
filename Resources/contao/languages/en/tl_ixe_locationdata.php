...
$GLOBALS['TL_LANG'][$strName]['new'] = ['Add new location', 'Here you can add a new location'];
$GLOBALS['TL_LANG'][$strName]['edit'] = ['Edit location', 'Edit location (ID %s)'];
$GLOBALS['TL_LANG'][$strName]['copy'] = ['Copy location', 'Copy location (ID %s)'];
$GLOBALS['TL_LANG'][$strName]['delete'] = ['Delete location', 'Delete location (ID %s)'];
$GLOBALS['TL_LANG'][$strName]['toggle'] = ['Publish/unpublish location', 'Publish/unpublish location (ID %s)'];
$GLOBALS['TL_LANG'][$strName]['show'] = ['Show information of location', 'Show information of location (ID %s)'];
$GLOBALS['TL_LANG'][$strName]['main_legend'] = 'Location name and type';
$GLOBALS['TL_LANG'][$strName]['icon_legend'] = 'Icon settings';
$GLOBALS['TL_LANG'][$strName]['image_legend'] = 'Image settings';
$GLOBALS['TL_LANG'][$strName]['address_legend'] = 'Adress settings';
$GLOBALS['TL_LANG'][$strName]['contact_legend'] = 'Contact settings';
...
$GLOBALS['TL_LANG'][$strName]['streetAdditional'] = ['Street additions', 'Here you can put additional information to the street'];
$GLOBALS['TL_LANG'][$strName]['postalCode'] = ['Post code', 'Here you can put the post code of the location'];
$GLOBALS['TL_LANG'][$strName]['addressLocality'] = ['City', 'Here you can put the city of the location'];
...
$GLOBALS['TL_LANG'][$strName]['telephoneLinktext'] = ['Phone linktext', 'Optional: You can add a text which will be shown as the link for the phone number in here'];
$GLOBALS['TL_LANG'][$strName]['faxNumberCteText'] = ['Fax CTE-text', 'Here you can add a cte text in front of the contact numbers'];
...
$GLOBALS['TL_LANG'][$strName]['addLink'] = ['Add link', 'Here you can choose if you wish to add a hyperlink to the location'];
$GLOBALS['TL_LANG'][$strName]['additionalProperty'] = ['Further Information', 'Here you can add further information to the location'];
$GLOBALS['TL_LANG'][$strName]['linkTitle'] = ['Link text', 'This Link text will be shown instead of the link adress.'];
$GLOBALS['TL_LANG'][$strName]['embed'] = ['Embed the link', 'Use the placeholder "%s", to embed the link into a text (e.g. For more information visit %s).'];
$GLOBALS['TL_LANG'][$strName]['titleText'] = ['Link title', 'The link title will be added to the title-attribute within the HTML-markup.'];
$GLOBALS['TL_LANG'][$strName]['rel'] = ['Lightbox', 'Use a data-lightbox-attribute to create a lightbox for the link.'];
$GLOBALS['TL_LANG'][$strName]['published'] = ['Publish Location', 'Here you can publish / unpublish the location.'];
